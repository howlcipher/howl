...
| :--- | :--- | :--- | :--- |
| **[`howlInstinct`](https://github.com/howlcipher/howlInstinct)** | Fast semantic decision layer: typed judgments with explicit uncertainty and decision receipts. Confidence is not permission. | [howlcipher.github.io/howlInstinct](https://howlcipher.github.io/howlInstinct/) | Early (bootstrap MVP) |
| **[`howlforge`](https://github.com/howlcipher/howlforge)** | AI workforce definition and runtime selection for HowlFutureWorks: durable roles, replaceable runtimes, deterministic matching, handoff validation. Selects and explains; does not launch. | [howlcipher.github.io/howlforge](https://howlcipher.github.io/howlforge/) | Early (v1 library + CLI) |
