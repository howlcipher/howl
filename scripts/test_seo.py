...
def test_seo():
    ...
    assert "Howl" in parser.title, "HTML <title> must include Howl"
    print("  [PASS] HTML <title> exists and is descriptive:", parser.title.strip())
    ...
    # 3. Canonical
    expected_canonical = "https://howlcipher.github.io/howl/"
    ...
    print("  [PASS] Internal entity link to William Elias portfolio verified")
    ...
    assert "Sitemap: https://howlcipher.github.io/howl/sitemap.xml" in robots, "robots.txt missing Sitemap reference"
